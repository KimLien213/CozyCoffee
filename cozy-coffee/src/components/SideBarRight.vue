<template>
  <v-navigation-drawer app color="white" right width="290">
          ...
          <v-list-item>
              ...
              <v-list-item-content>
                  ...
                  <v-list-item-subtitle>X1
                      <v-btn plain color="#3A6D5B" small>Notes
                          ...
                          <v-row>
                              <v-col cols="12" md="12">
                                  <v-list-item three-line class="text-center mt-1">
                                      <v-list-item-content>
                                          <div>
                                              <v-icon :color="active ? '#3A6D5B' : 'black'">fas fa-money-bill-wave</v-icon>
                                          </div>
                                          <v-list-item-subtitle
                          ...
                          <v-row>
                              <v-col cols="12" md="12">
                                  <v-list-item three-line class="text-center mt-1">
                                      <v-list-item-content>
                                          <div>
                                              <v-icon :color="active ? '#3A6D5B' : 'black'">fas fa-credit-card</v-icon>
                                          </div>
                                          <v-list-item-subtitle
                          ...
                          <v-row>
                              <v-col cols="12" md="12">
                                  <v-list-item three-line class="text-center mt-1">
                                      <v-list-item-content>
                                          <div>
                                              <v-icon :color="active ? '#3A6D5B' : 'black'">fas fa-qrcode</v-icon>
                                          </div>
                                          <v-list-item-subtitle
      ...
      <div class="mx-3 mt-2">
          <v-btn color="#3A6D5B" block dark class="widthoutupercase">Print Bills</v-btn>
      </div>
  </v-navigation-drawer>
</template>
...
<style>
    .v-card.borderme{
        border:2px solid #3A6D5B !important;
    }
    .col-12 {
